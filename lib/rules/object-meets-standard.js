    ...
    create: function(context) {
        ...
        return {
            ArrowFunctionExpression: function(node) {
                ...
                // If there is no explicit return, just return early for now.
                if (!returnNode) {
                    return;
                }
                ...
                // Re-construct the returned action object, using the AST and escodegen.
                // TODO: find a way to do this without eval!
                // escodegen returns the object as a string - can't use JSON.parse if the obj keys aren't wrapped in quotes
                eval(`var actionObject=${escodegen.generate(returnNode.argument)}`);
